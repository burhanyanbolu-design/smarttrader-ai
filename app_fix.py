...
scheduler.add_job(auto_start, 'cron', day_of_week='mon-fri', hour=9,  minute=30, timezone='America/New_York')
scheduler.add_job(auto_stop,  'cron', day_of_week='mon-fri', hour=15, minute=0,  timezone='America/New_York')
scheduler.start()
